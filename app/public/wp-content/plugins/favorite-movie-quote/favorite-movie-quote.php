...
// Main function that will render elements on page.
function render_favorite_movie_quote( $attributes ) {

	$favoriteMovieQuote = $attributes['fav_quote'] ;

	echo $favoriteMovieQuote;
}